<template>
    <div class="modal fade" id="addPostionModal" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text"  class="form-control" v-model="nameDivision" disabled>
...
<script>
    export default {
        ...
        mounted () {
            ...
            .then((res) => {
                this.form.division_id = res.data.data.id;
                this.nameDivision = res.data.data.name;
            })
            .catch((errors) => {
                console.log(errors);
            });
        ...
        methods: {
            ...
            UpdateListPosi() {
                axios.get(`/api/admin/positions-divisions/` + this.form.division_id)
            .then((response) => {
                this.$emit('listPosition',response.data.data);
            })
            .catch((error) => {
                console.log(error);
            });
